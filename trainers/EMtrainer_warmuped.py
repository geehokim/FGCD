...
class EMTrainer():
    ...
    def __init__(self,
        ...
        checkpoints = torch.load(
            'checkpoints/cifar10/dirichlet0.05/SimGCD_dir0.05_cifar10_lr0.1_warmup_proto/res18.pt.e5')

        print('checkpoints/cifar10/dirichlet0.05/SimGCD_dir0.05_cifar10_lr0.1_warmup_proto/res18.pt.e5')
        print(self.model.load_state_dict(checkpoints['model_state_dict']))
