...
def cluster_by_infomap(features, knn_method='faiss-gpu', tao_f = 0.6, k=10, dataset_name='others', silent=False):
    """
    基于infomap的聚类
    @features: np, [-1, 768]
    """
    ...
    # build link
    infomapWrapper = infomap.Infomap("--two-level --directed", silent=silent)
