...
_HOOK_LAYER_TYPES = (
     Bottleneck, BasicBlock, nn.Conv2d, nn.AdaptiveAvgPool2d, nn.MaxPool2d, nn.modules.batchnorm._BatchNorm, nn.GroupNorm)
    ...
    def _register_hook_recursive(self, module: nn.Module, hook_fn: Callable, prev_name: str = "") -> None:
        for name, child in module.named_children():
            ...
            if isinstance(child, self.hook_layer_types):
                # print("named child: ", name)
                # print("this is the instance of self.hook_layer_types: OOO")
            ...
            # else:
            #     print("named child: ", name)
            #     print("this is not instance of self.hook_layer_types: XXX")
            #     print(type(child))
                #print(
