...
class ShuffleNet_base(nn.Module):
    ...
    def __init__(self,args, num_classes=100,num_blocks = [4, 8, 4], groups=3,**kwargs):
        super().__init__()
...
class ShuffleNet_GFLN(nn.Module):

    def __init__(self, num_blocks = [4, 8, 4], num_classes=100, groups=3, *args ,**kwargs):
        super().__init__()
...
class ShuffleNet_Proc(ShuffleNet_GFLN):

    def __init__(self, num_blocks=[4, 8, 4], num_classes=100, groups=3, *args, **kwargs):
        super().__init__(num_blocks, num_classes, groups, *args, **kwargs)
