...
class SimGCD_Update_Prior_Global_Mask_Client():
    ...
    def setup(self, model, device, local_dataset, global_epoch, local_lr, trainer, **kwargs):
        ...
        if global_epoch >= self.args.client.start_update and global_epoch >= self.args.trainer.warmup:
            if self.args.client.update_alg == 'threshold_finch':
                ...
                num_clusters, est_prior_current, all_acc, old_acc, new_acc, aligned_w, aligned_preds, ind_map_pred_to_gt = update_prior(self.args, copy.deepcopy(self.prior_dist), copy.deepcopy(self.model),
    ...
    def local_train(self, global_epoch, **kwargs):
        ...
        results = {
            ...
            'novel_class_mask': novel_class_mask,
        }
    ...
    def get_centroids(self, model, loader, evaler, K, device):
        ...
        unseen_classes = torch.unique(targets_unlabelled[targets_unlabelled >= 5]).tolist()
