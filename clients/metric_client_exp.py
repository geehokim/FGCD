...
class MetricClient_exp(Client):
    ...
    def _get_prototypes(self, features, labels):
        ...
        var_of_prototypes = torch.norm((prototypes_ - prototypes_mean), dim = 1).mean()
    ...
    def _algorithm_metric(self, local_results, global_results, labels):
        ...
        for l in range(self.num_layers):
            ...
            if train_layer:
                ...
                losses['diff_loc_glob_prototypes_mean'].append((glob_prototypes_mean -  loc_prototypes_mean).mean())
